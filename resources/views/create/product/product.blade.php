...
@section('content')
    ...
    <div class="sidebodydiv px-4 py-1">
        <div class="sidebodyhead">
            ...
            <a data-bs-toggle="modal" data-bs-target="#addbrand"><button class="listbtn">Add Product</button></a>
        </div>
        <!-- <div>
                      ...
                      <tr>
                         ...
                         <td> 
                          <div class="d-flex align-items-center gap-2">
                            ...
                            @if ($product_value->status === 'Active')
                                    <button class="btn btn-sm btn-danger status_button" data-status_button="{{ $product_value->status }}">Inactive</button>
                                @else
                                    <button class="btn btn-sm btn-success status_button" data-status_button="{{ $product_value->status }}">Active</button>
                            @endif
                             
                            <a data-bs-toggle="modal" data-bs-target="#editproduct"><i
                                        class="fas fa-pen-to-square edit_button" data-id="{{ $product_value->id }}"></i></a>
                                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title mb-2" id="addbrandLabel">Add Product</h4>
    ...
    <div class="modal fade" id="editproduct" tabindex="-1" aria-labelledby="editbrandLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4 class="modal-title mb-2" id="editbrandLabel">Edit Product</h4>
                    <form action ="{{ route('product_store') }}" method="POST">
                        @csrf                  
                        <div class="col-sm-12 col-md-12 mb-1">
                            <label for="brandname" class="col-form-label">Product Name</label>
   ...
   $(document).ready(function () {
       $(".status_button").on("click", function () {
          ...
          //alert(status);
            ...
            $.ajax({
                url: "{{ route('create.prostatus-update') }}",
                type: "POST",
                data: {
                    status: status,
...
<script>
       ...
       // $('#brand_id').val('');
        ...
        $.ajax({
            url: "{{ route('edit.product-profile') }}",
            type: "POST",
            data: {
                id: id,
                _token: "{{ csrf_token() }}"
