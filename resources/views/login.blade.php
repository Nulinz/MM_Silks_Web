                ...
                <div class="center">
                    ...
                    <div class="form-holder row">
                        <div class="col-10 mx-auto mb-2">
                            <input type="text" class="form-control" name="contact" placeholder="User Mobile" required
                                autofocus>
                        </div>
                        <div class="col-10 mx-auto mb-2">
                            <div class="inpflex">
                        ...
                        <!--<a href="{{ route('dashboard.index') }}" class="text-decoration-none w-100"><button type="button"
                            class="submit-btn">Login</button></a>--> 
                </div>
            </div>
        </form>
